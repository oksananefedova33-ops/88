...
<div class="wrap" style="grid-template-columns: 1fr 280px !important;">
  <!-- УДАЛЕНА левая панель навигации -->
...
(function(){
  ...
  function createTopbarNav() {
    ...
    if (seoBar && seoBar.nextSibling) {
      seoBar.parentNode.insertBefore(navBar, seoBar.nextSibling);
    } else if (seoBar) {
      seoBar.parentNode.appendChild(navBar);
    }
